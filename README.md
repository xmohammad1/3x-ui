...
[![](https://img.shields.io/github/v/release/xmohammad1/3x-ui.svg)](https://github.com/xmohammad1/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/xmohammad1/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/xmohammad1/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/xmohammad1/3x-ui/total.svg)](#)
...
<p align="left">
  <a href="https://buymeacoffee.com/xmohammad1" target="_blank">
...
```
bash <(curl -Ls https://raw.githubusercontent.com/xmohammad1/3x-ui/master/install.sh)
```
...
```
VERSION=v1.7.9 && bash <(curl -Ls "https://raw.githubusercontent.com/xmohammad1/3x-ui/$VERSION/install.sh") $VERSION
```
...
wget https://github.com/xmohammad1/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. **Clone the Project Repository:**
   ...
   ```sh
   git clone https://github.com/xmohammad1/3x-ui.git
   cd 3x-ui
   ```
...
3. **Start the Service:**
   ...
   **OR**
   ...
   docker run -itd \
      ...
      --name 3x-ui \
      ghcr.io/xmohammad1/3x-ui:latest
   ```
...
[![Stargazers over time](https://starchart.cc/xmohammad1/3x-ui.svg?variant=adaptive)](https://starchart.cc/xmohammad1/3x-ui)
