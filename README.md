...
```
VERSION=v1.7.9 bash <(curl -Ls "https://raw.githubusercontent.com/xmohammad1/3x-ui/refs/tags/$VERSION/install.sh") $VERSION
```
...
[![Stargazers over time](https://starchart.cc/xmohammad1/3x-ui.svg)](https://starchart.cc/xmohammad1/3x-ui)
