...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/xmohammad1/3x-ui/v$tag_version/install.sh") v$tag_version"
...
update_shell() {
    wget -O /usr/bin/x-ui -N https://github.com/xmohammad1/3x-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
